...
<body>
    ...
    <button onclick="nextWeek()">Tuần Kế Tiếp</button>
    <button onclick="currentWeek()">Tuần Hiện Tại</button>
        ...
        if ($checkngaydangky) {
            ...
            if (!empty($ngaynghi) && !empty($lydo) && !empty($ca)) {
                ...
                if ($kq) {
                    ...
                    header('refresh:0,url=XemLich_DKNghiPhep.php');
                } else {
