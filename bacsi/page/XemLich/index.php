...
#leaveForm input[type="text"], #leaveForm input[type="submit"], #leaveForm button {
    width: 100%;
    padding: 10px;
    margin: 8px 0 16px 0;
...
#leaveForm input[type="text"]:focus, #leaveForm input[type="submit"]:hover, #leaveForm button:hover {
    border-color: #4682B4;
    outline: none;
    box-shadow: 0 0 10px rgba(70, 130, 180, 0.5);
}

#leaveForm input[type="submit"], #leaveForm button {
...
#leaveForm input[type="submit"]:hover, #leaveForm button:hover {
...
.shift-morning {
    background-color: #d1e7ff;  /* Màu cho ca sáng */
    border-color: #80b3ff;
}

.shift-afternoon {
    background-color: #fff3cd;  /* Màu cho ca chiều */
    border-color: #ffec8b;
}

.shift-evening {
    background-color: #e2e3e5;  /* Màu cho ca tối */
    border-color: #b1b3b8;
}
...
<div class="main-content" id="main-content">
    ...
    <div id="notification" style="display:none; padding: 10px; margin: 10px 0; border-radius: 5px; font-size: 14px;"></div>
